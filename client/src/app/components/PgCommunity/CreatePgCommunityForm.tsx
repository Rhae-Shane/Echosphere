...
interface CreatePgCommunityFormProps {
    onSuccess: () => void;
    onCancel: () => void;
}

const CreatePgCommunityForm: React.FC<CreatePgCommunityFormProps> = ({ onSuccess, onCancel }) => {
    const [formData, setFormData] = useState<CreatePgCommunityData>({
        name: '',
        address: '',
        description: ''
    });
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            setLoading(true);
            await pgCommunityService.createPgCommunity({
                ...formData,
